...
<?php
    // Qst1 :
        $employes = [
            "employe1"=>["nom"=>"HNID","poste"=>"consultant","salaire"=>15000],
            "employe2"=>["nom"=>"berak","poste"=>"Developpeur web","salaire"=>25000],
            "employe3"=>["nom"=>"hafadi","poste"=>"Developpeur mobile","salaire"=>30000],
            "employe4"=>["nom"=>"samaoui","poste"=>"Developpeur web","salaire"=>25000],
    ...
    // Qst3 :
        $users = [
            ...
            "user1"=>["email"=>"HnidAimane@gmail.com","password"=>123456789],
            "user2"=>["email"=>"Hnid.Aimane@gmail.com","password"=>43218465],
            "user3"=>["email"=>"Hnid.Aim@gmail.com","password"=>20050435],
        ];
        $email = $_POST["email"];
